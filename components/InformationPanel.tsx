  ...
  return (
    <div className="bg-gradient-to-br from-[#394F68] to-[#183B7E] text-white p-10">
        ...
        <div>
          <Image
            src={`https://www.weatherbit.io/static/img/icons/${
              weatherToCodeString[results.current_weather.weathercode].icon
            }.png`}
      ...
      <div className="space-y-2 py-5">
        <div className="flex items-center space-x-2 px-4 py-3 border borter-[#6F90CD] rounded-md bg-[#405885]">
